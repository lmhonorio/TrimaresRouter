...
{
    public class UdpSerial : MAVcomm.Comms.ICommsSerial
    {
      //  private static readonly ILog log = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);
        ...
        public UdpSerial(string iptoBroadcast, int nPort) 
        {
            IP_tobroadcast = iptoBroadcast;
            Port = nPort.ToString();
            ServerIP = new IPEndPoint(IPAddress.Parse(IP_tobroadcast), nPort);
        }
        ...
        private void start()
        {
            startThread = new Thread(new ThreadStart(startcomm));
            startThread.Start();
        }
        ...
        private void startcomm()
        {
          ...
          //  log.Info("TCP Open");
            ...
            RemoteIpEndPoint = new IPEndPoint(IPAddress.Parse(IP_tobroadcast), int.Parse(Port));
         ...
         //   client.Client.NoDelay = true;
            rMessage("Cliente Conectado UDP");
