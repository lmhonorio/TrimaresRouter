    ...
    public partial class MAVLink
    {
       ...
       // private static readonly ILog log = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);
        ...
        public void connect()
        {
            ...
            if (BaseStream.IsOpen && MainCrossData.cs.groundspeed > 4)
            {
         ...
         //   clearLogs();
            ...
            else
            {
                ...
                try
                {
                  ...
                  // DefaultConnection(comPortName, 115200);
        ...
        public byte[] ReturnByteArray(object indata) 
        {
            byte a = 0;
            foreach (Type ty in MAVLINK_MESSAGE_INFO)
            {
                if (ty == indata.GetType())
                {
                    return ReturnByteArray(a, indata);
                }
                a++;
        ...
        public byte[] ReturnByteArray(byte messageType, object indata) 
        {
            lock (objlock)
            {
                byte[] data;
        ...
        public void setAPType()
        {
            switch (apname)
            {
                case MAV_AUTOPILOT.ARDUPILOTMEGA:
                    switch (aptype)
                    {
                        case MAVLink.MAV_TYPE.FIXED_WING:
                            MAV.cs.firmware = MainCrossData.Firmwares.ArduPlane;
                            break;
                        case MAVLink.MAV_TYPE.QUADROTOR:
                            MAV.cs.firmware = MainCrossData.Firmwares.ArduCopter2;
                            break;
                        case MAVLink.MAV_TYPE.HELICOPTER:
                            MAV.cs.firmware = MainCrossData.Firmwares.ArduHeli;
                            break;
                        case MAVLink.MAV_TYPE.GROUND_ROVER:
                            MAV.cs.firmware = MainCrossData.Firmwares.ArduRover;
                            break;
                        default:
                            break;
                    }
                ...
                case MAV_AUTOPILOT.GENERIC:
                    ...
                    {
                        case MAVLink.MAV_TYPE.FIXED_WING:
                            MAV.cs.firmware = MainCrossData.Firmwares.Ateryx;
                            break;
                    }
                    break;
            }
...
//       // public bool MainCrossData.giveComport;
//        /// <summary>
//        /// used for outbound packet sending
//        /// </summary>
//        byte packetcount = 0;
...
//        public byte setMavlinkVersion 
//        {
//            get { return mavlinkversion; }
//            set{mavlinkversion = value;}
//        }
...
//            try
//            {
//                this.BaseStream.BaudRate = baudRate;
//                this.BaseStream.PortName = portName;
//            }
//            catch (Exception exp) {  }
...
//        void ProgressReporterDoWorkAndParams()
//        {
//            OpenBg(true);
//        }

//        void ProgressReporterDoWorkNOParams()
//        {
//            OpenBg(false);
//        }

//        void ProgressReporterDoWorkAndParams(object sender)
//        {
//            OpenBg(true);
//        }

//        void ProgressReporterDoWorkNOParams(object sender)
//        {
//            OpenBg(false);
//        }
...
//                    if (retrys > 0)
//                    {
//                        //log.Info("getWPCount Retry " + retrys + " - giv com " + MainCrossData.giveComport);
//                        generatePacket(MAVLINK_MSG_ID_MISSION_REQUEST_LIST, req);
//                        start = DateTime.Now;
//                        retrys--;
//                        continue;
...
//                                case (byte)MAV_CMD.LOITER_TIME:
//                                    if (MainCrossData.APMFirmware == MainCrossData.Firmwares.ArduPlane)
//                                    {
//                                        loc.p1 = (byte)(wp.param1 / 10);	// APM loiter time is in ten second increments
//                                    }
//                                    else
...
//                if (translateMode(modein, ref mode, this.sysid))
//                {
//                    setMode(mode);
//                }
//            }
...
//                        {
//                            MainCrossData.cs.datetime = DateTime.Now;
...
//            MainCrossData.cs.linkqualitygcs = (ushort)((packetsnotlost / (packetsnotlost + packetslost)) * 100.0);
...
//                    if (retrys > 0)
//                    {
//                        //log.Info("getFencePoint Retry " + retrys + " - giv com " + MainCrossData.giveComport);
//                        generatePacket(MAVLINK_MSG_ID_FENCE_FETCH_POINT, req);
//                        start = DateTime.Now;
//                        retrys--;
//                        continue;
...
//            MainCrossData.cs.datetime = lastlogread;
...
//        public static bool translateMode(string modein, ref MAVLink.mavlink_set_mode_t mode, byte mySysid)
//        {
//            //MAVLink09.mavlink_set_mode_t mode = new MAVLink09.mavlink_set_mode_t();
//            mode.target_system = mySysid;
...
//            {
//                case MAVLink.MAV_TYPE.FIXED_WING:
//                    MainCrossData.cs.firmware = MainCrossData.Firmwares.ArduPlane;
//                    break;
//                case MAVLink.MAV_TYPE.QUADROTOR:
//                    MainCrossData.cs.firmware = MainCrossData.Firmwares.ArduCopter2;
//                    break;
//                case MAVLink.MAV_TYPE.GROUND_ROVER:
//                    MainCrossData.cs.firmware = MainCrossData.Firmwares.ArduRover;
//                    break;
//                default:
//                    break;
//            }
